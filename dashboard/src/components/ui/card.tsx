...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-display text-base leading-snug font-bold tracking-[-0.01em] group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-[var(--radius)] border-t-2 border-foreground bg-muted p-4 group-data-[size=sm]/card:p-3",
        className
      )}
      {...props}
    />
