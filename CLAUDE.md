...
cada 15 min 24/7) lee **solo la bandeja `mensajes`** de Inmuebles24 —desde el
2026-09-04 se ignoran `telefono` ("Vió teléfono") y `whatsapp` ("Contactó por
Whatsapp"): ninguna de las dos es una consulta, la persona no escribió nada—
